    ...
    use App\Http\Controllers\RekapPertanyaanController;
    ...
    */
    ...
    Route::middleware('auth')->prefix('admin')->group(function () {
        ...
        // Route::get('/hasil-kuesioner/{masyarakat}', [HasilKuesionerController::class, 'show'])->name('hasil-kuesioner.show');
        Route::get('/hasil-kuesioner/{hasil}', [HasilKuesionerController::class, 'show'])->name('hasil-kuesioner.show');
